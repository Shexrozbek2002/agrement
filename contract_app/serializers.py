...
class ConcludingContractSerializer(GeoModelSerializer):
    class Meta:
        ...
        fields = ['region', 'payment_amount', 'district', 'cadastre_number', 'product_type', 'adress_location',
                  'square_of_services', 'applicant_organization', 'applicant_tin', 'applicant_fullname',
                  'applicant_phone', 'service_type']
